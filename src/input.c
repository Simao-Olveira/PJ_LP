 ...
 * Consome todos os caracteres pendentes no buffer de entrada num ciclo 
 ...
 * Utiliza um ciclo `while` que verifica três condições de erro simultaneamente:
 ...
 * Se houver erro, limpa o buffer e pede novamente.
 ...
 * Utiliza `fgets` para garantir que nunca lê mais caracteres do que o tamanho do buffer.
 * Verifica o último caracter lido:
 ...
 * Nesse caso, chama a função `cleanInputBuffer` para descartar o excesso e impedir erros futuros.
 */
